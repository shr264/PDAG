...
get_metrics_by_method = function(method, nlambda, Btype, m, n, seed, m1=NULL,m2=NULL,m3=NULL,m4=NULL,m5=NULL,m6=NULL,m7=NULL,m8=NULL,m9=NULL){
  ...
  save(Bhatlist, file = paste("Bhatlist","n",toString(n),"seed",toString(seed),".RData",sep=""))
  save(B, file = paste("trueB","n",toString(n),"seed",toString(seed),".RData",sep=""))

  return(get_avg_metrics2(B, Bhatlist, n, p, method, Btype, mean(time_vec), seed, debug=FALSE))
}

get_metrics_by_method_pcalgBG = function(method, nlambda, Btype, m, n, seed, m1=NULL,m2=NULL,m3=NULL,m4=NULL,m5=NULL,m6=NULL,m7=NULL,m8=NULL,m9=NULL){
  load(paste("Bhatlist","n",toString(n),"seed",toString(seed),".RData",sep=""))
  load(paste("trueB","n",toString(n),"seed",toString(seed),".RData",sep=""))
  i = 1
  ...
  p = dim(Bhatlist[[1]])[1]
  time_vec = rep(0, length(Bhatlist))
  for (i in 1:length(Bhatlist)){
    current_run = get(method)(Bhatlist[[i]],m1=m1,m2=m2,m3=m3,m4=m4,m5=m5,m6=m6,m7=m7,m8=m8,m9=m9)
    Bhatlist[[i]] = current_run$B
    time_vec[i] = current_run$time
  }
  
  return(get_avg_metrics2(B, Bhatlist, n, p, method, Btype, mean(time_vec), seed, debug=FALSE))
}

generate_tables_pcalg = function(Methods,Btypes,Ns,Seeds, m = NULL, m1=NULL,m2=NULL,m3=NULL,m4=NULL,m5=NULL,m6=NULL,m7=NULL,m8=NULL,m9=NULL){
  for (BB in Btypes){
    for (CC in Ns){
      for (DD in Seeds){
        if(exists('table1cur')){
          table1cur = rbind(table1cur,get_metrics_by_method(method = 'pcalg_custom',
                                                      nlambda = 30,
                                                      Btype = BB,
                                                      m = m,
                                                      n = CC,
          ...
          table1cur = get_metrics_by_method(method = 'pcalg_custom',
                                         nlambda = 30,
                                         Btype = BB,
                                         m = m,
                                         n = CC,
    ...
    for (BB in Btypes){
      for (CC in Ns){
        for (DD in Seeds){
          if(exists('table1cur')){
            if(AA != 'pcalg_custom'){
              table1cur = rbind(table1cur,get_metrics_by_method_pcalgBG(method = AA,
                                                                  nlambda = 30,
                                                                  Btype = BB,
                                                                  m = m,
                                                                  n = CC,
  ...
  for (AA in Methods){
    for (BB in Btypes){
      for (CC in Ns){
        for (DD in Seeds){
          if(exists('table1cur')){
            table1cur = rbind(table1cur,get_metrics_by_method(method = AA,
                                                        nlambda = 30,
                                                        Btype = BB,
                                                        m = m,
                                                        n = CC,
            ...
            table1cur = get_metrics_by_method(method = AA,
                                           nlambda = 30,
                                           Btype = BB,
                                           m = m,
                                           n = CC,
...
##Table 0
table0_pcalg = generate_tables_pcalg(Methods = c('pcalg_custom', 'addBG2','addBG3','addBG4',
                                      'addBG2_t','addBG3_t','addBG4_t'),
...
# generate_tables_pcalg(Methods = c('pcalg_custom', 'addBG2'),
#                       Btypes = c('genB_rand_40'),
#                       Ns = c(75),
#                       Seeds = 1,
#                       m = 4,
...
save(table0_pcalg, file = "table0_pcalg.RData")


#Table 1
table1_pcalg = generate_tables_pcalg(Methods = c('pcalg_custom', 'addBG2', 'addBG2_t'),
                ...
                m = 2,
                m1 = 25)
save(table1_pcalg, file = "table1_pcalg.RData")
...
# 
# # Table 2
table2_pcalg = generate_tables_pcalg(Methods = c('pcalg_custom', 'addBG2','addBG3','addBG4',
                                                     'addBG2_t','addBG3_t','addBG4_t'),
                Btypes = c('genB_mult_Yeast1','genB_mult_Yeast2','genB_mult_Yeast3',
                           'genB_mult_Ecoli1','genB_mult_Ecoli2'),
                Ns = c(40,50,100,200),
                ...
                m2 = 24,
                m3 = 36)
save(table2_pcalg, file = "table2_pcalg.RData")
# 
...
# 
# # Table 4
table4_pcalg = generate_tables_pcalg(Methods = c('pcalg_custom', 'addBG2','addBG3','addBG4',
                                           'addBG2_t','addBG3_t','addBG4_t'),
                ...
                m2 = 50,
                m3 = 75)
save(table4_pcalg, file = "table4_pcalg.RData")
# 
# print('table4')
# 
# values = expand.grid(list(
